...
export interface AirQualityMapped {
  index: number;
  name: string;
}
...
export interface DailyOrHourlyWeatherMapped {
  temperature: number | undefined;
  weatherName: string | undefined;
  weatherImg: string | undefined;
}
...
export interface WeatherMapped {
  city?: string;
  current?: CurrentWeatherMapped;
  hourly?: DailyOrHourlyWeatherMapped[] | [];
  daily?: DailyOrHourlyWeatherMapped[] | [];
}
